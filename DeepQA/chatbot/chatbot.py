...
class Chatbot:
    ...
    def parseArgs(args):
        ...
        datasetArgs.add_argument('--corpus', choices=['cornell', 'opensubs','scotus'], default='cornell', help='corpus on which extract the dataset. Only two corpus available right now (cornell and opensubs)')  # TODO: Replace by cst registered in textdata
    ...
    def main(self, args=None):
        ...
        """
        print('Welcome. I am tessa 0000.1. !')
        print()
